...
def generate_degrees(courses_taken):
    ...
    This function provides a set of degrees for which the user has completed the most courses, though particular categories
    and prerequisites are not fully accounted for.
    """
